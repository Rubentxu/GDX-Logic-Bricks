...
import com.indignado.logicbricks.utils.builders.actuators.EditRigidBodyActuatorBuilder;
import com.indignado.logicbricks.utils.builders.actuators.MotionActuatorBuilder;
import com.indignado.logicbricks.utils.builders.actuators.TextureActuatorBuilder;
...
public class PlayerPlatformTemp extends EntityFactory {
    ...
    public Entity createEntity() {
       ...
       // Create Bricks Idle ----------------------------------------------------------------
        ...
        stateActuatorIdle.changeState = stateComponent.getState("Idle");
       ...
       // Create Bricks Walking ----------------------------------------------------------------
        ...
        stateActuatorWalking.changeState = stateComponent.getState("Walking");
